...
- Синтез в голос текста на калмыцком языке:
  - набранного вручную
...
- Распознавание речи на калмыцком языке из загружаемого файла(.wav)
- Возможность сохранить распознанный фрагмент в текстовый файл(.txt)
